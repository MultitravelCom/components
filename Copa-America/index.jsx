...
async function fetchDataCopaAmerica() {
    try {
        const response = await fetch('https://32tpwbxjq7.us-east-1.awsapprunner.com/api/copa-americas?populate=*');
        if (!response.ok) {
            throw new Error('No se pudo obtener los datos de la API');
        }
...
const btnStyles = [
    { carrusel: "carrusel__lista", btnLeft: "btnLeft", btnRight: "btnRight", title: 'Paquetes Copa America', destino: "seccion_uno" },
    { carrusel: "carrusel__lista2", btnLeft: "btnLeft2", btnRight: "btnRight2", title: 'Paquetes Copa America', destino: "seccion_dos" },
    { carrusel: "carrusel__lista3", btnLeft: "btnLeft3", btnRight: "btnRight3", title: 'Vuelos a Estados Unidos ', destino: "seccion_tres" },
