function addHeaderLinks() {
  ...
  meta.setAttribute(
    "content",
    "Compará paquetes a la copa América y conseguí los mejores precios en alojamiento y vuelos a Bariloche, Iguazú y Mendoza. Solicitá atención personalizada por whatsapp"
  );
...
function App() {
  ...
  const seccion_uno = filtrarDestinos(destinos, "seccion_uno");
  const seccion_dos = filtrarDestinos(destinos, "seccion_dos");
  const seccion_tres = filtrarDestinos(destinos, "seccion_tres");
          ...
          <div className="main__conteiner main__conteiner-principal container">
            <div className="carrusel">
              {btnStyles.map((btnStyle, index) => {
                const destinosFiltrados = filtrarDestinos(
                  destinos,
                  btnStyle.destino
                );
                return (
                  <CardContainer
                    ...
                    onContactClick={() => handleOpenForm(index)}
                  />
                );
              })}
            </div>
