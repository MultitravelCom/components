function addHeaderLinks() {
  ...
  meta.setAttribute(
    "content",
    "Compará paquetes a la copa América y conseguí los mejores precios en alojamiento y vuelos"
  );
  ...
  modalAtencionsJs.src =
    "https://multitravelcom.github.io/components/MULT168/Modal/index.js";
  modalAtencionsJs.type = "text/babel";

  modalAtencionStyle.href =
    "https://multitravelcom.github.io/components/MULT168/Modal/style.css";
...
function verificarYActualizarMeta() {
  ...
  if (metaTag) {
    metaTag.setAttribute(
      "content",
      "https://multitravelcom.github.io/MT/multitravel.webp"
    );
  } else {
...
async function fetchDataCopaAmerica() {
  try {
    const response = await fetch(
      "https://32tpwbxjq7.us-east-1.awsapprunner.com/api/copa-americas?populate=*"
    );
    if (!response.ok) {
      throw new Error("No se pudo obtener los datos de la API");
    }
...
const fetchDestinos = async () => {
  const response = await fetch(
    "https://raw.githubusercontent.com/MultitravelCom/components/master/Copa-America/dbAmerica.json"
  );
...
const btnStyles = [
  {
    ...
    btnLeft: "btnLeft",
    btnRight: "btnRight",
    title: " Paquetes Copa América - primer partido fase de grupos - segundo partido fase de grupos - tercer partido fase de grupos",
    destino: "Seccion_1",
  },
  {
    ...
    btnLeft: "btnLeft2",
    btnRight: "btnRight2",
    title: " Paquetes Copa América - Cuartos de final - Semifinal - Final",
    destino: "Seccion_2",
  },
  {
    ...
    btnLeft: "btnLeft3",
    btnRight: "btnRight3",
    title: "Vuelos a Atlanta - Vuelos a Nueva York - Vuelos a Miami - Vuelos a Houston",
    destino: "Seccion_3",
  },
];
  ...
  React.useEffect(() => {
    if (isVisible && !isScriptLoaded) {
      ...
      const scriptElement = document.querySelector(
        'script[data-b24-form="inline/56/aj4a4r"]'
      );
      if (scriptElement) {
...
const ButtonBitrixForm = () => {
  ...
  return isMobile ? (
    <div className="bitrixFormTitle-button">
      <button onClick={handleCallButtonClick} className="style__btn__britrix">
        Llamar
      </button>
    </div>
  ) : null;
    ...
    <div className="BitrixFormTitle">
      <div className="bitrixFormTitle_text">
        <p className="single-line">
          Completa tus datos para que te contacte un especialista.
        </p>
      </div>
      {/* <ButtonBitrixForm /> */}
    </div>
...
function ButtonLading(props) {
  ...
  return (
    <button
      id={props.id}
      className={`btn_Style_Venta_Per ${props.className}`}
      onClick={handleClick}
    >
...
function shouldShowEvent() {
  const startDate = new Date("2023-11-05T22:00:00");
  const endDate = new Date("2024-11-12T23:30:00");
  const now = new Date();
        ...
        <>
          ...
          <div className="main__conteiner main__conteiner-principal container">
            <div className="carrusel">
              ...
              />
              <CardContainer
                btnStyles={btnStyles[1]}
                destinosFiltrados={seccion_dos}
                onContactClick={handleOpenForm}
              />
              <CardContainer
                btnStyles={btnStyles[2]}
